  ...
  onRender() {
    ...
    if (!this.$input) {
      ...
      this.onChange = function(target, that, opt, value) {
          ...
          var parent = $(selected.view.el.parentElement).data('model');
    ...
    // we have 2 more stuff to do before we finsih
      // 1. save - the reason it does not save is because the parent does not have a class, done
      // 2. show selected option in ui
